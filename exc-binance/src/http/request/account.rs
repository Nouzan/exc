...
/// Get details of futures account of a sub-account.
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
...
/// Get positions of futures account of a sub-account.
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetSubAccountFuturesPositions {
    /// Email.
    pub email: String,
    /// Type.
    pub futures_type: usize,
...
impl GetSubAccountFuturesPositions {
    /// USD-Margin future's account.
    pub fn usd(email: &str) -> Self {
        Self {
            email: email.to_string(),
